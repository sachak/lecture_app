...
• 60 / 120 Hz – responsive – clavier virtuel mobile
• Plein-écran : automatique si Streamlit ≥ 1.25, sinon bouton ⛶ manuel
"""
...
def html_fs(html: str, **kw):
    """Appelle components.html en restant compatible toutes versions."""
...
# ────── 2. tirage 80 mots (identique algorithme d’origine) --------------
