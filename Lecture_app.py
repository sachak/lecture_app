...
(familiarisation + test 80 mots, synchronisation à la frame / 60 Hz)
...
import streamlit.components.v1 as components   # composant HTML
...
# 0. ÉTATS SESSION
# =============================================================================
defaults = dict(page="screen_test",   # étape courante
                hz_ok=False,          # test 60 Hz validé ?
                tirage_ok=False,
...
# =============================================================================
# 3. CHARGEMENT EXCEL + TIRAGE DES 80 MOTS (fonctions identiques)
# =============================================================================
...
# =============================================================================
# 4A. HTML – TEST 60 Hz (READY + VALUE ok)
# =============================================================================
TEST60_HTML = r"""
...
<script>
Streamlit.setComponentReady();                     // ← déclaration « prêt »
...
document.getElementById("start").onclick = () => {
  ...
  const step = k => {
    ...
    if (t.length < n) { requestAnimationFrame(step); }
      ...
      let d = [];
      for (let i = 2; i < t.length; i++) d.push(t[i] - t[i-1]);
      ...
      if (ok) { Streamlit.setComponentValue("ok"); }  // ← envoi à Python
    }
  };
...
# =============================================================================
# 4C. FABRICATION PAGE EXPÉRIENCE
# =============================================================================
