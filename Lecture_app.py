...
(60 Hz, familiarisation 2 mots, test principal 80 mots)
...
if p.page == "screen_test":
    ...
    # mémorise immédiatement le succès et relance pour mettre l'état à jour
    ...
    if st.button("Passer à la présentation ➜"):
        p.page = "intro" if (p.hz_ok or hz_val == "ok") else "hz_fail"
        do_rerun()

# 0-bis : page d’échec (fréquence hors plage)
elif p.page == "hz_fail":
