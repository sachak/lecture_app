# -*- coding: utf-8 -*-
# =============================================================
# Lecture_app.py   – version stable (accollades sécurisées)
# =============================================================
...
# ---------- LANCER la sélection de 80 mots en tâche de fond -------------
...
# ========================================================================
#  PAGE D’ATTENTE (si stimuli pas prêts)
# ========================================================================
...
# ========================================================================
    ...
    STIMULI = st.session_state["stimuli"]      # liste de 80 mots
    params  = dict(stimuli=json.dumps(STIMULI), cycle=350, start=14, step=14)

    # --------------------------------------------------------------------
    #  Bloc HTML / JavaScript — toutes les accolades doublées {{ }}
    # --------------------------------------------------------------------
    html_tpl = """
...
run();
    ...
    html_code = html_tpl.format(**params)
